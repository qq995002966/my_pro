...
parser parser_tcp_options_length{
	...
	set_metadata(metadata_vcc_tcp_window.tcp_options_len_left,
				tmetadata_vcc_tcp_window.tcp_options_len_left - tcp_options_length.len + 1);
	//由于p4的局限性，这里只能使用比较笨的方法，把不需要的tcp options的值
	//解析出来扔掉。
	//这里参照了 include/net/tcp.h 中的那几种TCP options length，分别为
	// 2、3、4、6、10、18
	return select(tcp_options_length.len){
		2:parser_tcp_options_kind;
		3:parser_rubbish_3;
		4:parser_rubbish_4;
		6:parser_rubbish_6;
		10:parser_rubbish_10;
		18:parser_rubbish_18;
		default:ingress;
	}
}
